...
this.setState({value:type=='select'?this.selectValueFor(resource[name]()):resource[name]})}},{key:'render',value:function render(){var _props4=this.props,name=_props4.name,type=_props4.type;var _context=this.context,inline=_context.inline,resource=_context.resource;var input=type==='select'?this.createSelectElement():this.createInputElement();return _react2.default.createElement(inline?'span':'div',{},[input,_react2.default.createElement(Mitragyna.ErrorsFor,{attribute:name,resource:resource,key:'errors'})])}},{key:'createInputElement',value:function createInputElement(){var name=this.props.name;return _react2.default.createElement('input',_extends({},this.props,{key:name,onBlur:this.handleUpdate,onChange:this.handleChange,value:this.state.value}))}// TODO: Add support for non-resource options
