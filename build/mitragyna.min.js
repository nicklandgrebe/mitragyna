...
this.setState({value:this.valueFor(resource,props)})}},{key:'componentWillReceiveProps',value:function componentWillReceiveProps(nextProps,nextContext){var resource=nextContext.resource;this.setState({value:this.valueFor(resource,nextProps)})}// TODO: Add support for non-resource options on select and radio
