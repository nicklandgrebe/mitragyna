...
function Collection(){_classCallCheck(this,Collection);var _this=_possibleConstructorReturn(this,(Collection.__proto__||Object.getPrototypeOf(Collection)).call(this));_this.state={loading:true,target:_activeResource2.default.prototype.Collection.build()};_underscore2.default.bindAll(_this,'buildOnTarget','cloneTarget','replaceOnTarget','removeFromTarget');return _this}_createClass(Collection,[{key:'componentDidMount',value:function componentDidMount(){this.setTarget(this.props)}},{key:'componentWillReceiveProps',value:function componentWillReceiveProps(nextProps){this.setTarget(nextProps)}},{key:'setTarget',value:function setTarget(props){var _this2=this;var subject=props.subject;var isRelationship=subject.isA(_activeResource2.default.prototype.Associations.prototype.CollectionProxy);var setLoadedTarget=function setLoadedTarget(target){_this2.setState({loading:false,target:target})};if(isRelationship){if(subject.base.loaded()){setLoadedTarget(subject.base.target)}else{subject.load().then(setLoadedTarget)}}else if(!_underscore2.default.isUndefined(subject.all)){subject.all().then(setLoadedTarget)}}},{key:'buildOnTarget',value:function buildOnTarget(attributes){var subject=this.props.subject;var target=this.cloneTarget();target.push(subject.build(attributes));this.setState({target:target})}},{key:'replaceOnTarget',value:function replaceOnTarget(newItem,oldItem){var target=this.cloneTarget();target.replace(oldItem,newItem);return this.setState({target:target})}},{key:'removeFromTarget',value:function removeFromTarget(item){var target=this.cloneTarget();target.delete(item);return this.setState({target:target})}},{key:'cloneTarget',value:function cloneTarget(){return this.state.target.clone()}},{key:'render',value:function render(){var _this3=this;var _props=this.props,blankComponent=_props.blankComponent,children=_props.children,className=_props.className,component=_props.component,inlineRows=_props.inlineRows,rowClassName=_props.rowClassName;var _state=this.state,loading=_state.loading,target=_state.target;return _react2.default.createElement('section',{className:className},loading?_react2.default.createElement('span',null,'Loading'):target.size()>0?target.map(function(t){return _react2.default.createElement(Resource,{subject:t,key:t.localId,component:component,className:rowClassName,inline:inlineRows,afterUpdate:_this3.replaceOnTarget},children)}).toArray():blankComponent!=null&&blankComponent())}}]);return Collection}(_react2.default.PureComponent);Collection.propTypes={children:_propTypes2.default.oneOfType([_propTypes2.default.array,_propTypes2.default.node]),className:_propTypes2.default.string,blankComponent:_propTypes2.default.func,component:_propTypes2.default.func,inlineRows:_propTypes2.default.bool,rowClassName:_propTypes2.default.string,subject:_propTypes2.default.oneOfType([_propTypes2.default.object,_propTypes2.default.func]).isRequired};Collection.defaultProps={inlineRows:false};var ErrorsFor=exports.ErrorsFor=function(_React$PureComponent2){_inherits(ErrorsFor,_React$PureComponent2);function ErrorsFor(){_classCallCheck(this,ErrorsFor);return _possibleConstructorReturn(this,(ErrorsFor.__proto__||Object.getPrototypeOf(ErrorsFor)).apply(this,arguments))}_createClass(ErrorsFor,[{key:'render',value:function render(){var root=this.context.root;var field=this.props.field;if(_underscore2.default.size(root.errors().forField(field))<1){return null}return _react2.default.createElement('summary',null,_underscore2.default.map(root.errors().forField(field),function(message,code){return _react2.default.createElement('p',{key:code},message)}))}}]);return ErrorsFor}(_react2.default.PureComponent);ErrorsFor.propTypes={field:_propTypes2.default.string};ErrorsFor.contextTypes={root:_propTypes2.default.object};;var Field=exports.Field=function(_React$PureComponent3){_inherits(Field,_React$PureComponent3);function Field(){_classCallCheck(this,Field);var _this5=_possibleConstructorReturn(this,(Field.__proto__||Object.getPrototypeOf(Field)).call(this));_underscore2.default.bindAll(_this5,'createInputElement','createSelectElement','handleChange','handleUpdate');return _this5}_createClass(Field,[{key:'componentWillMount',value:function componentWillMount(){var _props2=this.props,name=_props2.name,type=_props2.type;var resource=this.context.resource;// Set initial value to that of the resources
this.setState({value:type=='select'?this.selectValueFor(resource[name]()):resource[name]||''})}},{key:'componentWillReceiveProps',value:function componentWillReceiveProps(nextProps,nextContext){var name=nextProps.name,type=nextProps.type;var resource=nextContext.resource;this.setState({value:type=='select'?this.selectValueFor(resource[name]()):resource[name]||''})}},{key:'render',value:function render(){var _props3=this.props,name=_props3.name,type=_props3.type;var resource=this.context.resource;return type==='select'?this.createSelectElement():this.createInputElement()}},{key:'createInputElement',value:function createInputElement(){var _props4=this.props,component=_props4.component,name=_props4.name;var inputProps=_underscore2.default.omit(this.props,_underscore2.default.keys(Field.propTypes));var finalComponent=component||'input';return _react2.default.createElement(finalComponent,_extends({},inputProps,{key:name,onBlur:this.handleUpdate,onChange:this.handleChange,value:this.state.value}))}// TODO: Add support for non-resource options
},{key:'selectValueFor',value:function selectValueFor(resource){return resource&&resource.id||''}},{key:'createSelectElement',value:function createSelectElement(){var _props5=this.props,component=_props5.component,includeBlank=_props5.includeBlank,name=_props5.name,options=_props5.options,optionsLabelKey=_props5.optionsLabelKey;var selectOptions=null;if(options.isEmpty()){throw'Input type="select" must have options'}else{selectOptions=options.map(function(o){return _react2.default.createElement('option',{key:o.localId,value:o.id},o[optionsLabelKey])});if(includeBlank){selectOptions=selectOptions.unshift(_react2.default.createElement('option',{key:-1,value:''}))}}var selectProps=_underscore2.default.omit(this.props,_underscore2.default.keys(Field.propTypes));var finalComponent=component||'select';return _react2.default.createElement(finalComponent,_extends({},selectProps,{key:name,onBlur:this.handleUpdate,onChange:this.handleChange,value:this.state.value}),selectOptions)}},{key:'handleChange',value:function handleChange(e){e.persist();this.setState({value:e.target.value})}},{key:'handleUpdate',value:function handleUpdate(e){e.persist();var _context=this.context,afterUpdate=_context.afterUpdate,resource=_context.resource;var _props6=this.props,name=_props6.name,type=_props6.type,options=_props6.options;var value=e.target.value;if(type==='select'){value=options.find(function(o){return o.id===value})}afterUpdate(resource.assignAttributes(_defineProperty({},name,value)))}}]);return Field}(_react2.default.PureComponent);Field.contextTypes={afterUpdate:_propTypes2.default.func,resource:_propTypes2.default.object};Field.propTypes={component:_propTypes2.default.func,includeBlank:_propTypes2.default.bool,name:_propTypes2.default.string.isRequired,options:_propTypes2.default.array,optionsLabelKey:_propTypes2.default.string,type:_propTypes2.default.string.isRequired};var Resource=exports.Resource=function(_React$PureComponent4){_inherits(Resource,_React$PureComponent4);function Resource(props,context){_classCallCheck(this,Resource);var _this6=_possibleConstructorReturn(this,(Resource.__proto__||Object.getPrototypeOf(Resource)).call(this));_underscore2.default.bindAll(_this6,'afterUpdate','updateRoot');var root=context.root;var reflection=props.reflection,subject=props.subject;var state={resource:subject};if(reflection){var reflectionInstance=root.klass().reflectOnAssociation(reflection);if(_underscore2.default.isUndefined(reflectionInstance))throw'Reflection '+reflection+' not found.';var inverseReflection=reflectionInstance.inverseOf();if(_underscore2.default.isUndefined(inverseReflection))throw'Reflection '+reflection+' must have inverse.';state=_extends({},state,{inverseReflection:inverseReflection,reflection:reflectionInstance})}_this6.state=state;return _this6}_createClass(Resource,[{key:'componentWillReceiveProps',value:function componentWillReceiveProps(nextProps){this.setState({resource:nextProps.subject})}},{key:'afterUpdate',value:function afterUpdate(newResource){var _context2=this.context,root=_context2.root,updateRoot=_context2.updateRoot;var _state2=this.state,inverseReflection=_state2.inverseReflection,resource=_state2.resource;debugger;if(inverseReflection){var oldTarget=resource.association(inverseReflection.name).target;var newTarget=newResource.association(inverseReflection.name).target;if(inverseReflection.collection()){var index=oldTarget.indexOf(root);updateRoot(newTarget.get(index))}else{updateRoot(target)}}else{this.updateRoot(newResource)}}},{key:'getChildContext',value:function getChildContext(){var root=this.context.root;var resource=this.state.resource;var childContext={afterUpdate:this.afterUpdate,isNestedResource:true,root:root||resource,resource:resource,updateRoot:this.updateRoot};return childContext}},{key:'render',value:function render(){var isNestedResource=this.context.isNestedResource;var _props7=this.props,children=_props7.children,className=_props7.className,component=_props7.component;var resource=this.state.resource;var body=null;if(component){body=_react2.default.createElement(component,{subject:resource})}else{body=children}if(!isNestedResource){body=_react2.default.createElement('form',null,body)}return _react2.default.createElement('section',{className:className},body)}},{key:'updateRoot',value:function updateRoot(newRoot){var _this7=this;var fromSave=arguments.length>1&&arguments[1]!==undefined?arguments[1]:false;var afterUpdate=this.props.afterUpdate;var resource=this.state.resource;this.setState({resource:newRoot});if(!_underscore2.default.isUndefined(afterUpdate))afterUpdate(newRoot,resource);debugger;if(!fromSave){debugger;newRoot.save(function(root){return _this7.updateRoot(root,true)})}}}]);return Resource}(_react2.default.PureComponent);Resource.propTypes={afterUpdate:_propTypes2.default.func,children:_propTypes2.default.oneOfType([_propTypes2.default.array,_propTypes2.default.node]),className:_propTypes2.default.string,component:_propTypes2.default.func,reflection:_propTypes2.default.string,subject:_propTypes2.default.object.isRequired};Resource.contextTypes={isNestedResource:_propTypes2.default.bool,root:_propTypes2.default.object,updateRoot:_propTypes2.default.func};Resource.childContextTypes={afterUpdate:_propTypes2.default.func,isNestedResource:_propTypes2.default.bool,resource:_propTypes2.default.object,root:_propTypes2.default.object,updateRoot:_propTypes2.default.func}});
